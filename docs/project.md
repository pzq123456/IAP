...
### 2.3 需求分析
#### 2.3.1 用户需求
系统能够实现游客的注册与登录功能；进行景区信息、路线规划、周边设施等信息的查询与景点的三维展示；能够生成游客的游览路线等信息。

#### 2.3.2 数据需求
数据需求是指在后续完成整个系统功能的过程中需要用到的数据。由于系统功能包含景区信息、路线规划、三维展示、地形三位分析，所以需要景点经纬度位置、景区dem数据、景点人流量、景区路网信息等数据。
...
2. 功能实现
  ...
  ![功能架构](./imgs/function.jpg)
  - 系统按照是否与地图有关分为非地图功能和地图功能。
